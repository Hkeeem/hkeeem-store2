...
const fetchLocation = useCallback(()=>{ setLocLoading(true); navigator.geolocation.getCurrentPosition(p=>{ const l={lat:p.coords.latitude,lng:p.coords.longitude}; setUserLoc(l); setLocLoading(false); showToast('تم تحديد موقعك ✅') },()=>setLoc
                                                                                                      const askAssistant = ()=>{
