    ...
    <div className="space-y-3">
      <div className="rounded-3xl bg-black text-white p-5">
        ...
        <div className="grid grid-cols-2 gap-2 mt-4">
          <a
            href={`mailto:${EMAIL}`}
            className="h-11 rounded-full bg-white/10 border grid place-items-center text-sm"
          >
            إيميل
          </a>
          ...
          <a
            ...
            className="h-11 rounded-full bg-[#25D366] grid place-items-center text-sm"
          >
            واتساب 0565604856
          </a>
        </div>

        <div className="bg-white rounded-2xl border p-3 mt-4">
