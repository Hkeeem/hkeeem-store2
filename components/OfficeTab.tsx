    ...
    <div className="rounded-3xl bg-black text-white p-5">
      ...
      <div className="grid grid-cols-3 gap-2 mt-5">
        ...
        <a
          ...
          className="h-11 rounded-full bg-[#25D366] grid place-items-center text-xs font-black"
        >
          واتساب<br/>{DISP}
        </a>
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="h-11 rounded-full bg-white text-black grid place-items-center text-xs font-black"
        >
          DealApp
        </a>
      </div>
